<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable" method="post" action="${blog_url!}/search">
    ...
    <form autocomplete="off" id="search-form" method="get" action="${blog_url!}/search" accept-charset="UTF-8" class="mdl-textfield__expandable-holder">
