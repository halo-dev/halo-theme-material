<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable" method="post" action="${context!}/search">
    ...
    <form autocomplete="off" id="search-form" method="get" action="${context!}/search" accept-charset="UTF-8" class="mdl-textfield__expandable-holder">
