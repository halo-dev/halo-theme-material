...
<script>lsloader.load("js_js","/${static!}/source/js/js.min.js?V/53wGualMuiPM3xoetD5Q==", true)</script>

<#include "../_widget/nprogress.ftl">
<#if settings.other_js_smoothscroll!true>
    <script>lsloader.load("sm_js","/${static!}/source/js/smoothscroll.js?lOy/ACj5suSNi7ZVFVbpFQ==", true)</script>
</#if>
...
<#if post??>
<script type="text/javascript" src="/${static!}/source/prism/js/prism.js"></script>
</#if>
